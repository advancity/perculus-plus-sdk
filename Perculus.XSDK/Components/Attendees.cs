...
namespace Perculus.XSDK.Components
{
    public class Attendees : PerculusEndpoint
    {
        ...
        public (AttendeeView attendee, ApiErrorResponse error) AddByUserId(string sessionId, string userId, string role = "u")
        {
        ...
        public (AttendeeView attendee, ApiErrorResponse error) AddAttendee(string sessionId, PostAttendeeView attendee)
        {
            ...
            return (attendeeView, responseView);
        }
        ...
        /// <param name="attendee"></param>
        /// <returns></returns>
        public (AttendeeView attendee, ApiErrorResponse error) UpdateByAttendanceCode(string sessionId, string attendanceCode, PostAttendeeView attendee)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
        ...
        /// <param name="attendee"></param>
        /// <returns></returns>
        public (AttendeeView attendee, ApiErrorResponse error) UpdateByEmail(string sessionId, string email, PostAttendeeView attendee)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
        ...
        /// <returns></returns>
        public (AttendeeView attendee, ApiErrorResponse error) GetByAttendanceCode(string sessionId, string attendanceCode)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
        ...
        /// <param name="email"></param>
        /// <returns></returns>
        public (AttendeeView attendee, ApiErrorResponse error) GetByEmail(string sessionId, string email)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
        ...
        /// <returns></returns>
        public (bool success, ApiErrorResponse error) DeleteByAttendanceCodeOrUserId(string sessionId, string attendanceCodeOrUserId)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
        ...
        /// <param name="email"></param>
        /// <returns></returns>
        public (bool success, ApiErrorResponse error) DeleteByEmail(string sessionId, string email)
        {
            if (String.IsNullOrEmpty(sessionId))
            {
                throw new ArgumentNullException(nameof(sessionId));
